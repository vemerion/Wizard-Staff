...
public class WarlockArmorModel<T extends LivingEntity> extends MagicArmorModel<T> {
	...
	public WarlockArmorModel(float modelSize) {
		...
		this.robe.addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, 0);
		this.rightShoulder1 = new ModelRenderer(this, 0, 116);
		this.rightShoulder1.setRotationPoint(1.0F, 0.0F, 0.0F);
		this.rightShoulder1.addBox(-2.5F, -2.5F, -2.5F, 5.0F, 5.0F, 5.0F, 0);
		...
		this.leftShoe3.addBox(-1.5F, 0.0F, -1.0F, 3.0F, 2.0F, 1.0F, 0);
		...
		this.leftShoulder1.addBox(-2.5F, -2.5F, -2.5F, 5.0F, 5.0F, 5.0F, 0);
		...
		this.leftShoe4.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 1.0F, 1.0F, 0);
		...
		this.rightShoulder3.addBox(0.0F, -1.5F, -1.0F, 1.0F, 3.0F, 2.0F, 0);
		this.leftSleeve = new ModelRenderer(this, 0, 90);
		this.leftSleeve.setRotationPoint(0.0F, 2.0F, 0.0F);
		this.leftSleeve.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0);
		...
		this.leftShoulder3.addBox(0.0F, -1.5F, -1.0F, 1.0F, 3.0F, 2.0F, 0);
		...
		this.rightShoe1.addBox(-2.5F, 0.0F, -2.5F, 5.0F, 8.0F, 5.0F, 0);
