...
public class GrapplingHookModel extends EntityModel<GrapplingHookEntity> {
    ...
    public GrapplingHookModel() {
        ...
        this.hook1.setRotationPoint(0.0F, 0.0F, 2.0F);
        ...
        this.base.addBox(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 0.0F);
        this.hook3 = new ModelRenderer(this, 0, 0);
        this.hook3.setRotationPoint(0.0F, 0.0F, 2.0F);
        ...
        this.hook5.setRotationPoint(0.0F, 0.0F, 2.0F);
        ...
        this.base.addChild(this.hook1);
        this.hook3.addChild(this.hook4);
        this.hook5.addChild(this.hook6);
        this.base.addChild(this.hook3);
        this.base.addChild(this.hook5);
	...
	public void setRotationAngles(GrapplingHookEntity entityIn, float limbSwing, float limbSwingAmount,
		...
		base.rotateAngleY = netHeadYaw;
		base.rotateAngleX = headPitch;
	}
