...
public class DruidArmorModel<T extends LivingEntity> extends MagicArmorModel<T> {
	...
	public DruidArmorModel(float modelSize) {
		...
		this.leftHorn5.addBox(-0.5F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, modelSize);
		...
		this.leftHorn3.addBox(-0.5F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F, modelSize);
		...
		this.rightHorn1.addBox(-0.5F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F, modelSize);
		...
		this.leftHorn4.addBox(-0.5F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, modelSize);
		...
		this.rightHorn2.addBox(-0.5F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F, modelSize);
		...
		this.rightHorn5.addBox(-0.5F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, modelSize);
		...
		this.rightHorn6.addBox(-0.5F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, modelSize);
		...
		this.rightHorn3.addBox(-0.5F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F, modelSize);
		...
		this.leftHorn1.addBox(-0.5F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F, modelSize);
		...
		this.leftHorn2.addBox(-0.5F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F, modelSize);
		...
		this.rightHorn4.addBox(-0.5F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, modelSize);
		...
		this.leftHorn6.addBox(-0.5F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, modelSize);
